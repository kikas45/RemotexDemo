package remotex.com.remotewebview.QrPages
...
import remotex.com.remotewebview.databinding.ActivityWiFiBinding
...
class WiFiActivity : AppCompatActivity() {
    ...
    private fun myWiFIConnect(ssid: String, get_WAp: String, pw: String) {
        ...
        when {
            ...
            encryptionType == "NOPASS" && pw == null -> { showAlertDialog(remotex.com.remotewebview.R.string.cannot_connect_to_encrypted_wifi_without_password)
            }
            else -> {
